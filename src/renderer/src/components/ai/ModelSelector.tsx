...
export function ModelSelector({ compact = false }: { compact?: boolean; direction?: 'up' | 'down' }): JSX.Element {
  ...
  const displayName = currentModel?.name ?? aiModel
  ...
  return (
    <>
      <button
        ...
        className={`flex items-center gap-1.5 rounded-lg border border-gray-700 hover:border-gray-500
      ...
      >
        ...
        <span className="text-gray-300 truncate max-w-[120px]">{displayName}</span>
