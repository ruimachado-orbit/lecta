...
import { SLIDE_LAYOUTS, LayoutThumbnail } from '../slides/SlideNavigator'
 ...
 * a thumbnail button, opening a grid of all layouts. Used by the outline step
 * so relayouting is visual, not a dropdown of names.
 */
